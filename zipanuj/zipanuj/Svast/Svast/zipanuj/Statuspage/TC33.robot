...
insideNewbutton
    ...
    Click Element   xpath://span[normalize-space()='New']
    input text      Xpath:/html/body/app-root/div/app-status/p-dialog/div/div/div[2]/form/div/div/div/input      pqr
    click button    xpath://button[normalize-space()='Submit']
    Sleep   2
    Click Element   xpath://span[normalize-space()='New']
    input text      Xpath:/html/body/app-root/div/app-status/p-dialog/div/div/div[2]/form/div/div/div/input     xyz
    click button    xpath://button[normalize-space()='Submit']
