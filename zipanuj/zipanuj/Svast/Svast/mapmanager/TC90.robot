...
${p/w}  Svast@1209
${emailmanager}     sanjay@mistpl.com


*** Test Cases ***
Managerprofilevld
    insideManagerprofilevld
...
insideManagerprofilevld
    ...
    click button    xpath://button[normalize-space()='Other Login']
    input text      Xpath://input[@type='text']     ${emailmanager}
    input text      Xpath://input[@type='password']     ${p/w}
    click button    xpath://button[normalize-space()='Login']
    go to   http://localhost:4200/#/manager/profile
    Element Text Should Be  xpath://div[normalize-space()='Sapna Mary']     Sapna Mary
    Element Text Should Be  xpath://div[normalize-space()='MGC_069!A1']     MGC_069!A1
    click button    xpath://button[normalize-space()='Logout']
    Sleep   2
    Close browser